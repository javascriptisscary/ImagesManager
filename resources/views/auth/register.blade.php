                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('answer') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="password" class="form-control" name="answer" value="{{ old('answer') }}">
                        ...
                        <div class="form-group{{ $errors->has('answer_confirmation') ? ' has-error' : '' }}">
                            <label class="col-md-4 control-label">Confirm Answer</label>

                            <div class="col-md-6">
                                <input type="password" class="form-control" name="answer_confirmation">

                                @if ($errors->has('answer_confirmation'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('answer_confirmation') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
